...
3. **Option boîtier IoT vs application chauffeur** : Le choix d'un boîtier GPS autonome garantit un envoi continu et passif des positions (toutes les 2s) sans dépendre d'une action du chauffeur. Une application sur tablette chauffeur aurait permis la saisie d'incidents (bouchons, pannes).
